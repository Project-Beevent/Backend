...
//                .findAll()
//                .stream()//converts the list of blood requests into a Stream -sequence of elements-
//                .map(BloodRequestDto::new)// transforms each element of the Stream into a BloodRequestDto
